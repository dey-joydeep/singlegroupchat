...
public class UserAgentInfo {
	...
	public boolean detectAndroidPhone() {
		...
		// Special check for Android devices with Opera Mobile/Mini. They should report
		// here.
	...
	public boolean detectAndroidTablet() {
		...
		// Special check for Android devices with Opera Mobile/Mini. They should NOT
		// report here.
		if (detectOperaMobile())
			return false;
	...
	public boolean detectWindowsMobile() {
		...
		// devices.
		if (userAgent.indexOf(deviceWinMob) != -1 || userAgent.indexOf(deviceIeMob) != -1
	...
	public boolean detectTierIphone() {
		if (detectIphoneOrIpod() || detectAndroidPhone() || detectWindowsPhone() || detectBlackBerry10Phone()
				...
				|| detectTizen() || detectFirefoxOSPhone() || detectSailfishPhone() || detectUbuntuPhone()
